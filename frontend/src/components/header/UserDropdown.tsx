      ...
      >
        ...
        <div className="pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          {user?.role === "SUPERADMIN" && (
            <span className="mt-1.5 inline-block text-xs font-medium text-purple-600 dark:text-purple-400 bg-purple-100 dark:bg-purple-900/30 px-2 py-0.5 rounded-full">
              Super Admin
            </span>
          )}
        </div>
        ...
        <ul className="flex flex-col gap-1 py-3 border-b border-gray-200 dark:border-gray-800">
          ...
          {user?.role === "SUPERADMIN" && (
            <li>
              ...
              >
                <svg className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M8 7a4 4 0 1 0 8 0A4 4 0 0 0 8 7m-4.243 9H20.243A7 7 0 0 0 8 14H8a7 7 0 0 0-4.243 2z" fill="" />
                </svg>
                Manajemen User
              </DropdownItem>
            </li>
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 mt-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 w-full text-left transition-colors"
        >
          <svg className="fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
