        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">Masuk ke akun Anda</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <a
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
