...
import * as __fd_glob_15 from "../content/docs/developer/webhooks.mdx?collection=docs";
import * as __fd_glob_14 from "../content/docs/developer/authentication.mdx?collection=docs";
import * as __fd_glob_13 from "../content/docs/developer/api-overview.mdx?collection=docs";
import * as __fd_glob_12 from "../content/docs/getting-started/installation.mdx?collection=docs";
import * as __fd_glob_11 from "../content/docs/getting-started/first-quiz.mdx?collection=docs";
import * as __fd_glob_10 from "../content/docs/core/creating-quiz.mdx?collection=docs";
import * as __fd_glob_9 from "../content/docs/core/collections.mdx?collection=docs";
import * as __fd_glob_8 from "../content/docs/core/analytics.mdx?collection=docs";
...
export const docs = await create.docs(
  ...
  },
  {
    ...
    "core/analytics.mdx": __fd_glob_8,
    "core/collections.mdx": __fd_glob_9,
    "core/creating-quiz.mdx": __fd_glob_10,
    "getting-started/first-quiz.mdx": __fd_glob_11,
    "getting-started/installation.mdx": __fd_glob_12,
    "developer/api-overview.mdx": __fd_glob_13,
    "developer/authentication.mdx": __fd_glob_14,
    "developer/webhooks.mdx": __fd_glob_15,
